...
public final class ELFeaturesMixinPlugin extends MixinPluginBase {
    ...
    public ELFeaturesMixinPlugin() {
        ...
        createConstraintGroup("textures")
                .add("SkinProvider$V1",                 "[4764,4998]")  // 26.1-snapshot-1 - 26.3-snapshot-1
                .add("SkinProvider$V2",                 "[4999,)")      // 26.3-snapshot-2 and newer
                .add("SkinProvider1$V1",                "[4764,4998]")  // 26.1-snapshot-1 - 26.3-snapshot-1
                .add("SkinProvider1$V2",                "[4999,)")      // 26.3-snapshot-2 and newer
