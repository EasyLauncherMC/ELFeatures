...
public final class ELFeaturesMixinPlugin extends MixinPluginBase {
    ...
    public ELFeaturesMixinPlugin() {
        ...
        createConstraintGroup("textures")
                ...
                .add("SkinManager$V1",                  "[3684,4537]")  // 23w42a (1.20.3) - 25w33a (1.21.9)
                ...
                .add("SkinManager1$V2",                 "[3684,4537]")  // 23w42a (1.20.3) - 25w33a (1.21.9)
                .add("SkinManager1$V3",                 "[4539,4998]")  // 25w34a (1.21.9) - 26.3-snap-1
                .add("SkinManager1$V4",                 "[4999,)")      // 26.3-snap-2 and newer
