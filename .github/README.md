...
[supportedVersionsImg]: https://img.shields.io/badge/%D0%B2%D0%B5%D1%80%D1%81%D0%B8%D1%8F%20%D0%B8%D0%B3%D1%80%D1%8B-1.7.10%20%D0%B8%20%D0%BD%D0%BE%D0%B2%D0%B5%D0%B5-3BAF18?style=for-the-badge
...
> [EasyLauncher][easylauncher] сам на своей стороне незаметно встраивает мод в игру при запуске, и присутствие его в `mods/` будет только мешать.
...
|   Forge   | ✅ Поддерживается | `1.7.10` и новее |
| NeoForge  | ✅ Поддерживается | `1.20.2` и новее |
|   Quilt   | ✅ Поддерживается | `1.14.4` и новее |
| OptiFine  |  🚧 Планируется  | `1.7.2` и новее  |
|  Vanilla  |  🚧 Планируется  |  `1.6` и новее   |
